	    ...
	    for contract in contractList:
	        ...
	        for cLine in contractBlock:
	        	...
	        	if result4Function:
	        		#print(result4Function)
	        		#print(cLine)
	        		bufferBlock = bufferBlock + self.getCurrBlock(fileContent, cLine['idx'])
	        #print(bufferBlock)
	        for b in bufferBlock:
	        	if b in contractBlock:
	        		contractBlock.remove(b)
	        #contractBlock = contractBlock - bufferBlock
